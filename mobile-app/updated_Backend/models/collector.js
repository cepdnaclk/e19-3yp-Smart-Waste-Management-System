...
collector.statics.signup = async function (name, email, password) {
  // validation
...
collector.statics.login = async function (email, password) {
  if (!email || !password) {
    throw Error("All field should be filled");
  }
...
const Collector = mongoose.model("collector", collector);
