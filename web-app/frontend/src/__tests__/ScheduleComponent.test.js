...
mockAxios
  .onGet("http://3.228.104.45:1337/api/collector-details")
  .reply(200, sampleCollectors);
mockAxios
  .onGet("http://3.228.104.45:1337/api/scheduleCollection")
  .reply(200, sampleSchedule);
mockAxios
  .onPost("http://3.228.104.45:1337/api/scheduleCollection")
